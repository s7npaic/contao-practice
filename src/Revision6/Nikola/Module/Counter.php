...
class Counter extends \Module
{
     ...
     * @var string
     */
    protected $strTemplate = 'mod_counting';
    ...
    protected function compile()
    {
        ...
        $count = $db->query("SELECT count FROM tl_counting")->count;
        $count++;
        $db->prepare('UPDATE tl_counting SET count = ?')->execute($count);
        $this->Template->bla = $count; 
