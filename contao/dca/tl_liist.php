...
(
    ...
    (
        ...
        (
            'edit'   => array
            (
                'label' => &$GLOBALS['TL_LANG']['tl_liist']['edit'],
                'href'  => 'act=edit',
                'icon'  => 'edit.gif'
            ),
            'delete' => array
            (
                'label'      => &$GLOBALS['TL_LANG']['tl_liist']['delete'],
                'href'       => 'act=delete',
                'icon'       => 'delete.gif',
            ...
            'show'   => array
            (
                'label' => &$GLOBALS['TL_LANG']['tl_liist']['show'],
                'href'  => 'act=show',
                'icon'  => 'show.gif'
            )
        )
    ...
    (
        ...
        'title'       => array
        (
            'label'     => &$GLOBALS['TL_LANG']['tl_liist']['title'],
            'search'    => true,
            'exclude'   => true,
            'inputType' => 'text',
        ...
        'description' => array
        (
            'label'     => &$GLOBALS['TL_LANG']['tl_liist']['description'],
            'exclude'   => true,
            'inputType' => 'textarea',
